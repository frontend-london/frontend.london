/*!
 * Frontend.London Gruntfile based on Bootstrap's Gruntfile
...
//  var generateRawFiles = require('./grunt/bs-raw-files-generator.js');
  ...
  grunt.initConfig({
    ...
    banner: '/*!\n' +
            ' * Frontend.London v<%= pkg.version %> (<%= pkg.homepage %>)\n' +
...
//    },
    ...
    watch: {
      ...
      less: {
//        files: 'less/*.less',
        files: ['less/*.less', 'less/portfolio/*.less'],
//        files: {
//          "css/*.css": "less/*.less"
//        },
        tasks: 'less'
...
//  grunt.registerTask('dist-docs', 'copy:docs');
  ...
  grunt.registerTask('dist', ['clean', 'dist-css', 'copy:fonts', 'copy:images', 'dist-js']);
